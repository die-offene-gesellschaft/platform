...
Content.seed(:id,
  ...
  { id: 6, controller_action_name: 'application#faciliation', key: 'faciliation', value: File.read("#{Rails.root}/db/fixtures/contents/faciliation.md"), order: 1 },
  ...
  { id: 8, controller_action_name: 'participate#show', key: 'support', value: File.read("#{Rails.root}/db/fixtures/contents/participate/support.md"), order: 1 },
  { id: 9, controller_action_name: 'participate#show', key: 'diy', value: File.read("#{Rails.root}/db/fixtures/contents/participate/diy.md"), order: 2 }
)
